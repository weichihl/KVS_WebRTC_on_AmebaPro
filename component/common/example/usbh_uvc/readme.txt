...
~~~~~~~~~~~
        ...
        2. For GCC environmnet, type command "make menuconfig" and choose CONFIG USB => Enable USB => USB OTG Type => 
           ...
           set to USBH_UVC_APP_MMF_RTSP in example_usbh_uvc.c as default, user could manually unset CONFIG_V4L2_EN/CONFIG_RTSP_EN/CONFIG_RTP_CODEC_EN/CONFIG_MMF_EN 
        ...
        7. Please make sure to reserve enough heap size for UVC by raising configTOTAL_HEAP_SIZE in freeRTOSconfig.h & turning off some functions
           (e.g. WPS, JDSMART, ATcmd for internal and system) since image frame storing will consume quite large memory space.
