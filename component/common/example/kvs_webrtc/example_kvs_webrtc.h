...
#else
    #define KVS_VIDEO_HEIGHT    VIDEO_1080P_HEIGHT
    #define KVS_VIDEO_WIDTH     VIDEO_1080P_WIDTH
#endif
#define KVS_VIDEO_OUTPUT_BUFFER_SIZE    KVS_VIDEO_HEIGHT*KVS_VIDEO_WIDTH
