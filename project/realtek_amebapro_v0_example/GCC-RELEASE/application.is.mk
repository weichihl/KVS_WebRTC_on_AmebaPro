...
SRC_C += ../../../component/common/network/lwip/lwip_v2.0.2/src/netif/ppp/polarssl/md5.c
...
all: LIBFLAGS += -l_codec -l_dct -l_faac -l_h264 -l_haac -l_http -l_mmf -l_muxer -l_p2p -l_rtsp -l_sdcard -l_soc_is -l_speex -l_usbd -l_websocket -l_wlan -l_wps -l_qr_code -l_mdns -l_tftp
mp: LIBFLAGS += -l_codec -l_dct -l_faac -l_h264 -l_haac -l_http -l_mmf -l_muxer -l_p2p -l_rtsp -l_sdcard -l_soc_is -l_speex -l_usbd -l_websocket -l_wlan_mp -l_wps -l_qr_code -l_mdns -l_tftp
